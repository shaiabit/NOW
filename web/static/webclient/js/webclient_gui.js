...
// Handle image and text coming from the server

function onImage(args, kwargs){
    // append image under previous message, then scroll to position
    // at the bottom.
    var mwin = $("#messagewindow");
    mwin.append("<img src='" + args[0] + "' />");
    mwin.animate({scrollTop: document.getElementById("messagewindow").scrollHeight}, 0);
}

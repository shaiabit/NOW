...
commit 0640392c38fbe9b84ff9d66cb1ac1a54189c325c
"""
...
class CmdBan(COMMAND_DEFAULT_CLASS):
    ...
    key = "@ban"
    aliases = ["@bans"]
    locks = "cmd:perm(ban) or perm(immortal)"
    help_category = "Administration"
...
class CmdUnban(COMMAND_DEFAULT_CLASS):
    ...
    """
    key = "@unban"
    locks = "cmd:perm(unban) or perm(immortal)"
    help_category = "Administration"
...
class CmdDelAccount(COMMAND_DEFAULT_CLASS):
    ...
    key = "@delaccount"
    locks = "cmd:perm(delaccount) or perm(immortal)"
    help_category = "Administration"
...
class CmdNewPassword(COMMAND_DEFAULT_CLASS):
    ...
    key = "@userpassword"
    locks = "cmd:perm(newpassword) or perm(wizard)"
    help_category = "Administration"
...
class CmdPerm(COMMAND_DEFAULT_CLASS):
    ...
    key = "@perm"
    aliases = "@setperm"
    locks = "cmd:perm(perm) or perm(immortal)"
    help_category = "Administration"
